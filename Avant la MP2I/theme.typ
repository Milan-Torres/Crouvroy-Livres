      ...
      #align(left)[
        #box(
          path(
            ...
            + place(top + left)[#text(
                white,
                underline(smallcaps("Question " + cpt_qst.display("1"))),
                size: 1.1em,
                weight: "medium",
              )],
        )
          ...
          polygon(
            ...
            + context (
              place(top + left)[#text(
                  white,
                  underline(smallcaps(
                    "Théorème " + cpt_part.display() + "-" + cpt_thm.display(),
                  )),
                  size: 1.1em,
                  weight: "medium",
                )
      ...
      #align(left)[
        #box(
          polygon(
            ...
            + place(top + left)[#text(
                white,
                underline(smallcaps("Aller plus loin ")),
                size: 1.1em,
                weight: "medium",
              )
              #text(white, "(" + title + ")", size: 1em, weight: "semibold")
    ...
    rect(
      ...
      #align(left)[
        #box(
          place(top + left)[#text(
              black,
              underline(smallcaps("Démonstration")),
              size: 1.1em,
              weight: "medium",
            )
          ],
...
#let document(
  ...
  set text(font: "DejaVu", size: 1.01em)
  set align(center)
